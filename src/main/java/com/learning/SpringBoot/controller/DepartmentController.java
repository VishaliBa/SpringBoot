...
public class DepartmentController {
    ...
    private Class<DepartmentController> name;
    ...
    public Department fetchDepartmentByName(@PathVariable("name") String departmentaName){
        return departmentService.fetchDepartmentByName(departmentaName);
    }
}
